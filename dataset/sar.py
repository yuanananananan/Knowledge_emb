...
class SAR_Dataset(Dataset):
    ...
    def __init__(self, root_dir, transform=None, img_size=(128, 128), is_aug=True, cfg=None):
        self.cfg = cfg
    ...
    def __getitem__(self, idx):
        ...
        img_source = resize_and_pad_image(img_source, self.img_size)
        ...
        if self.transform:
            if self.is_train and self.is_aug:
                ...
                img = img_source.resize(self.img_size)
...
def get_sar_dataset_full(cfg):
    ...
    dataset = SAR_Dataset(root_dir=root_dir, transform=transform, img_size=img_size, is_aug=is_aug, cfg=cfg)
